...
- `src/jobhunter/` — the package ([AGENTS.md](src/jobhunter/AGENTS.md))
  - `sources/` — ATS adapters, no I/O ([AGENTS.md](src/jobhunter/sources/AGENTS.md))
  - `archive/` — content-addressed write-once store: local FS / S3-R2
    ([AGENTS.md](src/jobhunter/archive/AGENTS.md))
  - `store/` — Postgres schema, lifecycle write path, board panel, queries
    ([AGENTS.md](src/jobhunter/store/AGENTS.md))
- `tests/` — pytest suite mirroring the package ([AGENTS.md](tests/AGENTS.md))
- `docs/` — design docs; `docs/README.md` is the index of what's current
  ([AGENTS.md](docs/AGENTS.md))
- `prototypes/parsing/` — retired rule parser, reference only
  ([AGENTS.md](prototypes/parsing/AGENTS.md))
